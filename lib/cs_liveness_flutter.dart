...
class CsLiveness {
  ...
  ///
  /// ```
  CsLiveness({required String clientId, required String clientSecret, required bool vocalGuidance, String? identifierId, String? cpf}) {
    _clientId = clientId;
    ...
    if(identifierId != null) {
      _identifierId = identifierId as String;
    }else {
      _identifierId = "";
    }
